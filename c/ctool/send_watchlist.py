#!/usr/bin/env python3
"""
send_watchlist.py — run lifchang pipeline, email watchlistd.md format.
...
<p style="color:gray;font-size:12px;">Auto-generated by GitHub Actions (lifchang). Not investment advice.</p>
</body></html>"""
