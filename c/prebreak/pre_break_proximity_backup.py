...
META_PATH = os.path.join(CTOOL_DIR, "share_data", "stock_meta.csv")
STOCK_LIST_PATH = os.path.join(CTOOL_DIR, "all_a_stocks.csv")
SHARE_DIR = os.path.join(CTOOL_DIR, "share_data")
